...
const Footer = () => {
  ...
  return (
    <footer className="w-full h-auto border-t-2 border-slate-200 ">
      <section className="w-[90%] mx-auto  grid grid-cols-4 pt-5 text-blue-100">
        <div id="warranty&services" className="  ">
          <h2 className="text-[1rem] font-semibold ">WARRANTY & SERVICE</h2>

          <div className="flex flex-col py-6 gap-y-2 text-orange-300">
            <Link to="/extend-warranty">extend-warranty</Link>
            <Link to="/care-maintain">care-maintain</Link>
          </div>
        </div>
        <div id="company" className="text-blue-100">
        ...
        <div id="address" className="">
          ...
          <div className="  py-6  text-orange-300">
            <ul className="">
              <li className="pb-5">
